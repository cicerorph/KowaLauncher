...
/**
 * Add an offline account. This will create a local account without any authentication.
 * The account will be stored in the configuration database.
 * 
 * @param {string} username The offline username (3-16 characters, alphanumeric and underscores).
...
exports.addOfflineAccount = async function(username) {
    try {
        // Generate a simple UUID based on the username
        ...
        log.error('Error while creating offline account', err)

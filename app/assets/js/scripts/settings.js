    ...
    authKeys.forEach((val) => {
        ...
        const accHtml = `<div class="settingsAuthAccount" uuid="${acc.uuid}">
            <div class="settingsAuthAccountLeft">
                <img class="settingsAuthAccountImage" alt="${acc.displayName}" src="https://starlightskins.lunareclipse.studio/render/default/${acc.type === "offline" ? "kowazalski" : acc.displayName}/full${acc.type === "offline" ? "?skinUrl=https://s.namemc.com/i/3538165200024b07.png" : ""}">
            </div>
